...
class PuzzleSulitActivity : AppCompatActivity() {
    private lateinit var textViewGrid: Array<Array<TextView>>
    private lateinit var viewModel: SulitViewModel
    private val rowSize = 7
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_puzzle_sulit)
        ...
        viewModel = ViewModelProvider(this, factory)[SulitViewModel::class.java]
