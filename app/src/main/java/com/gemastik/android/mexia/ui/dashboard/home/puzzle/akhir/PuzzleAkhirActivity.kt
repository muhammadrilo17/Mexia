package com.gemastik.android.mexia.ui.dashboard.home.puzzle.akhir
...
import com.gemastik.android.mexia.utils.puzzle.Word
import com.google.android.material.chip.Chip
import com.google.android.material.chip.ChipGroup
import kotlinx.android.synthetic.main.activity_puzzle_akhir.*

class PuzzleAkhirActivity : AppCompatActivity() {
    private lateinit var textViewGrid: Array<Array<TextView>>
    private lateinit var viewModel: AkhirViewModel
    private val rowSize = 8
    private val columnSize = 8
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_puzzle_akhir)
        ...
        createTextGrid()
        viewModel = ViewModelProvider(this, factory)[AkhirViewModel::class.java]
        viewModel.getAll5Words().observe( this, Observer { Words ->
            if (Words != null) {
                val temp: List<String> = Words.map { it.name }
                val words = listOf(temp[0], temp[1], temp[2], temp[3], temp[4], temp[5])
