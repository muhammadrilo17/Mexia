...
class PuzzleMudahActivity : AppCompatActivity() {
    private lateinit var textViewGrid: Array<Array<TextView>>
    private lateinit var viewModel: MudahViewModel
    private val rowSize = 5
    private val columnSize = 5
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_puzzle_mudah)
        ...
        viewModel = ViewModelProvider(this, factory)[MudahViewModel::class.java]

        if (viewModel.wordSearch.value == null) {
            viewModel.generateWordSearch(rowSize, columnSize)
        }
